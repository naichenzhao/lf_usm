...
#include "include/SEA_Y/SEA_ControllerY.h"
#include "_sea_controllery.h"
// ***** Start of method declarations.
// ***** End of method declarations.
#include "include/api/reaction_macros.h"
void _sea_controlleryreaction_function_0(void* instance_args) {
    _sea_controllery_self_t* self = (_sea_controllery_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    _sea_controllery_sea_pos_t* sea_pos = self->_lf_sea_pos;
    int sea_pos_width = self->_lf_sea_pos_width; SUPPRESS_UNUSED_WARNING(sea_pos_width);
    _sea_controllery_target_pos_t* target_pos = self->_lf_target_pos;
    int target_pos_width = self->_lf_target_pos_width; SUPPRESS_UNUSED_WARNING(target_pos_width);
    #line 55 "/Users/naichenzhao/Desktop/BML/lf_usm/src/lib/Joint_Controllers/SEA_Y.lf"
...
#line 54 "/Users/naichenzhao/Desktop/BML/lf_usm/src-gen/Main/_sea_controllery.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _sea_controlleryreaction_function_1(void* instance_args) {
    _sea_controllery_self_t* self = (_sea_controllery_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    ...
    _sea_controllery_out_t* out = &self->_lf_out;
    #line 96 "/Users/naichenzhao/Desktop/BML/lf_usm/src/lib/Joint_Controllers/SEA_Y.lf"
    float RISE_CAP = 1;
    float FALL_CAP = 5;
    if (self->fsm_state) {
...
#line 92 "/Users/naichenzhao/Desktop/BML/lf_usm/src-gen/Main/_sea_controllery.c"
}
#include "include/api/reaction_macros_undef.h"
_sea_controllery_self_t* new__sea_controllery() {
    _sea_controllery_self_t* self = (_sea_controllery_self_t*)lf_new_reactor(sizeof(_sea_controllery_self_t));
    ...
    self->_lf__reaction_0.function = _sea_controlleryreaction_function_0;
    ...
    self->_lf__reaction_1.function = _sea_controlleryreaction_function_1;
